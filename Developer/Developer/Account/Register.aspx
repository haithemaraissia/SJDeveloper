<%@ Page CodeFile="Register.aspx.cs" Title="" Language="C#" MasterPageFile="~/Plain.master"
    AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ToolkitScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:CreateUserWizard ID="SignUpCreateWizard" runat="server" ContinueDestinationPageUrl="~/Developer/Profile/ViewProfile.aspx"
